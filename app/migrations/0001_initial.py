# Generated by Django 5.2.1 on 2025-06-17 17:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('spearman', models.DecimalField(blank=True, decimal_places=0, max_digits=3, null=True)),
                ('pearson', models.DecimalField(blank=True, decimal_places=0, max_digits=3, null=True)),
