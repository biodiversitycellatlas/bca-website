...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='MetacellCount',
            fields=[
                ('materialized_id', models.AutoField(primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('common_name', models.CharField(help_text='Common name used for the species', max_length=100, unique=True)),
                ('scientific_name', models.CharField(help_text='Scientific name used for the species', max_length=100, unique=True)),
