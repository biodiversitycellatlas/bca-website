# Generated by Django 5.2.6 on 2025-11-05 10:34
...
class Migration(migrations.Migration):
    ...
    replaces = [('app', '0010_alter_genemodule_unique_together'), ('app', '0011_genemodule_eigenvalue'), ('app', '0012_alter_genemodule_unique_together_and_more'), ('app', '0013_alter_genemodule_genes_genemoduleeigenvalue_and_more')]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='genemodule',
            name='genes',
            field=models.ManyToManyField(related_name='gene_modules', through='app.GeneModuleMembership', to='app.gene'),
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='genemodule',
            name='eigenvalues',
            field=models.ManyToManyField(related_name='gene_modules', through='app.GeneModuleEigenvalue', to='app.metacell'),
        ),
    ]
