...
import { createActivityHeatmap } from "../plots/module_activity_heatmap.js";
...
export function loadEigenvalues(id, dataset) {
    let url = getDataPortalUrl("rest:genemoduleeigenvalue-list", dataset, null, 0, { sort_modules: 1 });
