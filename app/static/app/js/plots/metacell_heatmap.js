...
/**
 * Create metacell rug plot for the heatmap
 */
 ...
 * @param {Array} clip - Array with min and max scores to clip heatmap values.
 */
function createMetacellHeatmap(id, data, yField, yLabel, valueField, valueLabel, clip = [null, null]) {
