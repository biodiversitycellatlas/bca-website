...
urlpatterns = [
    ...
    path("downloads/<slug:slug>/", views.SpeciesFileDownloadView.as_view(), name="download_file"),
    path("docs/", views.DocumentationView.as_view(), {"page": "_index"}, name="docs"),
    path("docs/<path:page>/", views.DocumentationView.as_view(), name="docs"),
